# NFL2020fantasy-points-per-dollar-calcualtor
...
Methodology:
    ...
    - Missing data:
        - Made sure to leave out week 12 stats out when merging week 12 prices. This was done to avoid data leakage.
...
Output: A ranked Top 25 list of the best value players heading into Week 12, sorted by points per $1,000 of salary.
